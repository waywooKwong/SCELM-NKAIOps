...
timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S") + '_gemma2:2b'
...
def cluster_check_list_with_metrics(cluster_json_path, anomaly_csv_path):
    ...
    # 修改位置9：
    # print(f"cluster_check_list_with_metrics返回结果: {best_cluster},{anomaly_metrics}")
...
def write_to_csv(
    ...
    # 修改位置1：changes_data_bytedance_test
    # csv_file="/home/zhengtinghua/kuangweihua/ollama/mydocuments/cluster/changes_data.csv",
    csv_file="/home/zhengtinghua/kuangweihua/ollama/mydocuments/cluster/changes_data_bytedance.csv",
):
    """
    将一行数据写入指定的CSV文件
...
# 修改位置8：False改为True,开启Redis存储
add_to_redis = True  # "True" or "False"
# base_folder_path = "/home/zhengtinghua/kuangweihua/SCWarn_kontrast/areaText/English"
# 修改位置2：bytedance_test_onekpi_250311
# base_folder_path = "/home/zhengtinghua/kuangweihua/SCWarn_kontrast/areaText/kontrast_onekpi_250111"
base_folder_path = "/home/zhengtinghua/kuangweihua/SCWarn_bytedance/areaText/bytedance_onekpi_250313"
...
for kpi in kpis:
    ...
    embeddings = HuggingFaceEmbeddings(
        ...
        model_name="/home/zhengtinghua/kuangweihua/ollama/models/m3e-base", model_kwargs={"device": "cpu"}
    )
    ...
    for id in ids:
        ...
        # )
        anomaly_csv_path = os.path.join(
            "/home/zhengtinghua/kuangweihua/SCWarn_bytedance/process_mid_data/k1_csv_anomaly",
            f"{kpi}/csv_anomaly_{id}.csv",
        )
        ...
        if real_status == "normal":  # "normal" or "failure"
            ...
            # 修改位置4：
            ft_output_file = f"kuangweihua/ollama/mydocuments/cluster/{model_name}/bytedance/{timestamp}/{kpi}/ft.csv"
            # 检查文件是否存在
        ...
        os.makedirs(
            f"kuangweihua/ollama/mydocuments/cluster/{model_name}/bytedance/{timestamp}/{kpi}",
            exist_ok=True,
        )
        output_completion_file_path = f"kuangweihua/ollama/mydocuments/cluster/{model_name}/bytedance/{timestamp}/{kpi}/output_completion.txt"
        ...
        finetune_docs_path = "/home/zhengtinghua/kuangweihua/SCWarn_bytedance/areaText/English/finetune_docs.txt"
        ...
        top5_output_file = f"kuangweihua/ollama/mydocuments/cluster/{model_name}/bytedance/{timestamp}/{kpi}/top5_kpi.csv"
        # 打开文件，准备写入
        ...
        change_result_csv_file = f"kuangweihua/ollama/mydocuments/cluster/{model_name}/bytedance/{timestamp}/{kpi}/change_result.csv"
