...
model_name = "gemma2" # 2. 切换模型 qwen2.5/llama3.1/gemma2 gemma2:2b gemma2:27b

# base_folder_path = "/home/zhengtinghua/kuangweihua/SCWarn_kontrast/areaText/yunzhanghu_process_v2"
base_folder_path = "/home/zhengtinghua/kuangweihua/SCWarn_kontrast/areaText/yunzhanghu(1case)"
...
r1 = redis.Redis(host="localhost", port=6379, db=6)
...
llm_time = end_time_llm2 - start_time_llm
print(f"运行时间:{llm_time:.6f}秒")