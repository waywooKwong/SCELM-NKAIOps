...
# 增加一个 ablation 表示消融的后缀
timestamp = str(timestamp)+'_ablation'
...
r1 = redis.Redis(host="localhost", port=6379, db=4)
...
for id in ids:
    ...
    response_schema_01 = [
        ResponseSchema(name="change_type", description="specify 'normal' or 'failure'"),
        ResponseSchema(
